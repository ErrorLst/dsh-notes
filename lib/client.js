...
`;
		...
		function NotesDock(props) {
			...
			if (narrow && !userExpanded) return React.createElement("div", {
			...
			}, React.createElement("span", null, "📝"), React.createElement("span", null, "小计"), React.createElement("span", { dangerouslySetInnerHTML: { __html: ICON_EXPAND } })), React.createElement("div", {
				key: "tip",
				className: "np-tip",
				ref: tipRef,
				hidden: true
			...
			return React.createElement("div", {
				...
				key: "body",
				className: "dock-body"
			}, React.createElement("section", { className: "np-section" }, React.createElement("div", { className: "np-head" }, React.createElement("span", { className: "dot" }), React.createElement("span", { className: "t" }, "小计"), React.createElement("span", { className: "spacer" }), narrow && userExpanded ? React.createElement("button", {
				type: "button",
				className: "np-hbtn",
				"data-tip": "收起小计（回到胶囊）",
				onClick: () => setUserExpanded(false),
				dangerouslySetInnerHTML: { __html: ICON_COLLAPSE }
			}) : null), React.createElement("div", { className: "np-tabs" }, ...tabs), error === null ? null : React.createElement("div", { className: "np-error" }, "存储不可用，请检查宿主 storage 域。"), React.createElement("div", { className: "np-sec-todo" }, React.createElement("div", { className: "np-sec-head" }, React.createElement("span", { className: "np-sec-title" }, "待办"), React.createElement("span", { className: "np-sec-count" }, `共 ${todos.length} 项 · 未完成 ${todos.length - doneCount}`), React.createElement("button", {
				type: "button",
				className: "np-clear",
				"data-tip": "清空已完成",
